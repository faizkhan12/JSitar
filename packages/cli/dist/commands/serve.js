...
var local_api_1 = require("@jsitar/local-api");
...
exports.serveCommand = new commander_1.Command()
    ...
    if (filename === void 0) { filename = "readme.js"; }
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    console.log("Opened " + filename + " with port " + options.port + ". Navigate to http://localhost:" + options.port + " to edit the file");
                    return [3 /*break*/, 3];
                case 2:
                    err_1 = _a.sent();
                    if (err_1.code === "EADDRINUSE") {
                        ...
                        console.log("Something wrong ", err_1.message);
                    }
                    process.exit(1);
                    return [3 /*break*/, 3];
